...
class RestaurantsTest < ApplicationSystemTestCase
  ...
  test "creating a Restaurant" do
    ...
    fill_in "Cuisine", with: @restaurant.cuisine_id
    fill_in "Email", with: @restaurant.email
    fill_in "Facebook", with: @restaurant.facebook
    fill_in "Is Chain", with: @restaurant.is_chain
    fill_in "Name", with: @restaurant.name
    fill_in "Opening Times", with: @restaurant.opening_times
    fill_in "Postcode", with: @restaurant.postcode
    fill_in "Telephone", with: @restaurant.telephone
    fill_in "Twitter", with: @restaurant.twitter
