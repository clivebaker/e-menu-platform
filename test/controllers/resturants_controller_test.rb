...
class ResturantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resturant" do
    assert_difference('Resturant.count') do
      post resturants_url, params: { resturant: { address: @resturant.address, cuisine_id: @resturant.cuisine_id, is_chain: @resturant.is_chain, name: @resturant.name, postcode: @resturant.postcode } }
    end
  ...
  test "should update resturant" do
    patch resturant_url(@resturant), params: { resturant: { address: @resturant.address, cuisine_id: @resturant.cuisine_id, is_chain: @resturant.is_chain, name: @resturant.name, postcode: @resturant.postcode } }
