...
module Manager
  class MenusController < Manager::BaseController
    ...
    def menu_params
      params.require(:menu).permit(:restaurant_id, :nutrition, :provenance, :name, :description, :image, :spice_level_id, :node_type, :prices, :available, :calories, :position, :price_a, :price_b, menu_item_categorisation_ids: [], custom_lists: {} )
    end
  end
end
