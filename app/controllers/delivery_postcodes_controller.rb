class DeliveryPostcodesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @delivery_postcode.save
        format.html { redirect_to @delivery_postcode, notice: 'Delivery postcode was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @delivery_postcode.update(delivery_postcode_params)
        format.html { redirect_to @delivery_postcode, notice: 'Delivery postcode was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to delivery_postcodes_url, notice: 'Delivery postcode was successfully destroyed.' }
