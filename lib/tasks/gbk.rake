...
namespace :gbk do
  ...
  task restaurant: :environment do
  	...
  	first_bites = Menu.create(name: 'FIRST BITES', parent: menu, restaurant_id: restaurant.id, node_type: 'section')
  	...
  	go_smaller = Menu.create(name: 'GO SMALLER', parent: menu, restaurant_id: restaurant.id, node_type: 'section')
...
puts 'Importing Restaurant::GBK::Beef'
  	beef = Menu.create(name: 'BEEF', parent: menu, restaurant_id: restaurant.id, node_type: 'section')
		beef.translate
...
puts 'Importing Restaurant::GBK::chicken'
  	chicken = Menu.create(name: 'CHICKEN', parent: menu, restaurant_id: restaurant.id, node_type: 'section')
		chicken.translate
...
puts 'Importing Restaurant::GBK::Veggie'
  	veggie = Menu.create(name: 'VEGGIE & VEGAN', parent: menu, restaurant_id: restaurant.id, node_type: 'section')
		veggie.translate
...
puts 'Importing Restaurant::GBK::Lamb'
  	lamb = Menu.create(name: 'LAMB', parent: menu, restaurant_id: restaurant.id, node_type: 'section')
		lamb.translate
...
puts 'Importing Restaurant::GBK::Specials'
  	specials = Menu.create(name: 'SPECIALS', parent: menu, restaurant_id: restaurant.id, node_type: 'section')
		specials.translate
...
puts 'Importing Restaurant::GBK::Salads'
  	salads = Menu.create(name: 'SALADS', parent: menu, restaurant_id: restaurant.id, node_type: 'section')
		salads.translate
...
puts 'Importing Restaurant::GBK::Fries'
  	fries = Menu.create(name: 'FRIES & SIDES', parent: menu, restaurant_id: restaurant.id, node_type: 'section')
		fries.translate
...
puts 'Importing Restaurant::GBK::Sauces'
  	sauces = Menu.create(name: 'SAUCES', parent: menu, restaurant_id: restaurant.id, node_type: 'section')
		sauces.translate
...
puts 'Importing Restaurant::GBK::Milkshakes'
  	milkshake = Menu.create(name: 'MILKSHAKES', parent: menu, restaurant_id: restaurant.id, node_type: 'section')
		milkshake.translate
...
puts 'Importing Restaurant::GBK::FreshFizzy'
  	fresh = Menu.create(name: 'FRESH & FIZZY', parent: menu, restaurant_id: restaurant.id, node_type: 'section')
		fresh.translate
...
puts 'Importing Restaurant::GBK::Soft'
  	soft = Menu.create(name: 'SOFT DRINKS', parent: menu, restaurant_id: restaurant.id, node_type: 'section')
		soft.translate
...
#   	gluten = Menu.create(name: 'GLUTEN FREE', parent: menu, restaurant_id: restaurant.id, node_type: 'section')
# 		gluten.translate
...
puts 'Importing Restaurant::GBK::BEER'
  	beer = Menu.create(name: 'BEER & CIDER', parent: menu, restaurant_id: restaurant.id, node_type: 'section')
		beer.translate
...
puts 'Importing Restaurant::GBK::Wine'
  	wine = Menu.create(name: 'WINES', parent: menu, restaurant_id: restaurant.id, node_type: 'section')
		wine.translate
...
puts 'Importing Restaurant::GBK::Cocktail'
  	cocktail = Menu.create(name: 'COCKTAIL COOLERS', parent: menu, restaurant_id: restaurant.id, node_type: 'section')
		cocktail.translate
